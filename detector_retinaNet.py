...
def process_video(input_path, output_path, model, conf_threshold=0.25):
    ...
    if not os.path.isfile(input_path):
        print(f"Файл по пути {input_path} не найден.")
        return
...
def main():
    ...
    """
    input_path = 'video/crowd.mp4'
    output_path = 'video/output_crowd.mp4'
    ...
    model = load_model()
    total_objects_count = process_video(input_path, output_path, model, conf_threshold=0.3)
